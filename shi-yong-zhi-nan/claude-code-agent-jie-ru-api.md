...
export ANTHROPIC_BASE_URL= https://router.dt-unicom-ai.com/api
...
```powershell
$env:ANTHROPIC_AUTH_TOKEN="你的控制台密钥"
...
setx ANTHROPIC_BASE_URL "https://router.dt-unicom-ai.com/api"
...
`ANTHROPIC_BASE_URL` →<code class="expression">space.vars.baseurl</code>
